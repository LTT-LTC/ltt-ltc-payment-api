...
namespace LTC.PaymentService.Controllers.Staff;

[RemoteService(Name = PaymentServiceRemoteServiceConsts.RemoteServiceName)]
[Area(PaymentServiceRemoteServiceConsts.ModuleName)]
[Route("/ltc/payment-service/staff/payment")]
[Route("/payment-service/staff/payment")]
public class StaffVnPayController : StaffPaymentControllerBase
{
    private readonly IVnPayAppService _vnPayAppService;

    public StaffVnPayController(IVnPayAppService vnPayAppService)
    {
