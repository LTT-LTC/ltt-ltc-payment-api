...
public class VnPayLegacyCreateController : AbpControllerBase
{
    private readonly IVnPayAppService _vnPayAppService;

    public VnPayLegacyCreateController(IVnPayAppService vnPayAppService)
    {
        _vnPayAppService = vnPayAppService;
    }

    /// <summary>
    /// Legacy compatibility route for creating signed VNPAY payment URL.
    /// Prefer role-scoped endpoints under /{role}/payment/create-payment-url.
    /// </summary>
    [HttpPost("create-payment-url")]
    [Consumes("application/json")]
    [Authorize]
    [Obsolete("Use /ltc/payment-service/{role}/payment/create-payment-url. This route remains for compatibility.")]
