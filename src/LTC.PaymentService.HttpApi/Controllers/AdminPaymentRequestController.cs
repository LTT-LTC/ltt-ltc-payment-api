...
public class AdminPaymentRequestController : AbpControllerBase
{
    private readonly IPaymentRequestAppService _appService;

    public AdminPaymentRequestController(IPaymentRequestAppService appService)
    {
        _appService = appService;
    }

    /// <summary>
    /// Retrieve all payment request list
    /// </summary>
    ...
    /// <summary>
    /// Retrieve specific payment request
    /// </summary>
