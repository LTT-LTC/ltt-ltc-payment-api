...
[Route("/payment-service/manager/payment")]
public class ManagerVnPayController : ManagerPaymentControllerBase
{
    private readonly IVnPayAppService _vnPayAppService;

    public ManagerVnPayController(IVnPayAppService vnPayAppService)
    {
